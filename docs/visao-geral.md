...
**Revisão das telas "Como Jogar" e "Sobre"**: o tutorial foi reorganizado em 11 passos cobrindo os três modos de jogo, personagens, sorteio, dado, casas especiais, desafios, minigames, vitória, recordes, áudio e controles. A tela "Sobre" agora apresenta as seções de apresentação, o que você encontra no jogo, modos disponíveis, conteúdo educativo, tecnologia e desenvolvimento, status do projeto e créditos, refletindo os 6 minigames, o Quiz, os 4 personagens oficiais e as 228 perguntas em 9 categorias. Nenhuma regra, modo ou gameplay foi alterado.
...
| Modo | Fluxo | Estado e término |
|---|---|---|
| Jogo Rápido | Escolha de um mundo → setup → sorteio → partida | Partida independente; a vitória encerra a sessão. |
